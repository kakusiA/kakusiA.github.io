...
layout: post
title: "04-09공부 정리"
date: 2025-04-09 12:44:24
---

## 객체지향이란

**요약:** 객체지향언어는 코드의 재사용성과 유지보수 용이성을 높이기 위해 설계된 프로그래밍 언어로, 객체지향 프로그래밍(OOP)의 핵심 개념에는 캡슐화, 상속, 추상화, 다형성이 포함된다. 클래스는 객체를 정의하는 설계도로, 객체는 클래스에서 생성된 실체를 의미한다. 객체는 속성과 기능으로 구성되며, 인스턴스는 특정 클래스에서 생성된 객체를 지칭한다.

클래스는 변수와 메서드를 포함하며, 사용자 정의 타입으로 사용된다. 객체 생성 시 변수 선언이 필요하며, 메서드는 코드를 재사용하고 관리하기 쉽게 한다. 메서드는 인스턴스 메서드와...
