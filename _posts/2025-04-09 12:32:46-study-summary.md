...
layout: post
title: "04-09공부 정리"
date: 2025-04-09 12:32:46
---

## 오늘공부

**요약:** 객체지향 언어는 코드의 재사용성과 유지보수 용이성을 높이기 위해 설계된 프로그래밍 언어로, 객체지향 프로그래밍(OOP)의 핵심 개념에는 캡슐화, 상속, 추상화, 다형성이 포함된다. 클래스는 객체의 설계도로, 객체는 실제 존재하는 사물이나 개념을 의미하며, 클래스에서 생성된 객체를 인스턴스라 한다. 

클래스는 변수와 메서드로 구성되며, 객체 생성 시 인스턴스 변수가 초기화된다. 메서드는 코드 중복을 줄이고 관리하기 쉽게 해주며, 특정 기능을 수행하는 문장들의 집합이다. 메서드는 기본형 매개변수와 참조형 매개변수로 나뉘며,...
